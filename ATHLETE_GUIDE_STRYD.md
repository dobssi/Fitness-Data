...
**RFL Trend (Relative Fitness Level)** — Your current running fitness as a percentage of your all-time peak. 100% means you're in the best shape you've ever been. Calculated from the ratio of your Stryd running power to heart rate, smoothed over 42 days. Power captures effort regardless of hills, wind, or terrain, so the reading reflects true physiological fitness. This is the single most important number on your dashboard.
...
Predicted finish times for 5K, 10K, half marathon, and marathon. Based on your current RFL trend, your peak critical power (370W), and your running economy — how efficiently you convert watts into speed. Running economy is measured from your recent Stryd data (the 90th percentile of your last 50 runs, reflecting near-best conditions). Predictions update with every run as your fitness changes. They assume reasonably flat road conditions — your Race Readiness cards adjust for specific course surfaces.
...
- **Dots** — Individual run RFL values (single-run fitness snapshots, from power/HR ratio)
...
**Power Zones** — Time in each power zone, derived from your critical power. More responsive than HR to hills, wind, and short efforts — power reacts instantly while HR lags.

**Race Effort** — Time spent at race-specific power outputs (Sub-5K, 5K, 10K, HM, Marathon power bands). Shows whether your training is targeting the right intensity for your upcoming race.
...
- **Target power** — The wattage needed for your predicted time, with a ±3% band
- **Predicted time** — Based on your current fitness and running economy, adjusted for the course surface
- **Effort minutes (14d / 42d)** — Time spent training at race-specific power recently. More is better for race preparation.
